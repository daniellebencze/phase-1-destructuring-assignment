...
const animalType = farmAnimals.split(' ');
const [moo, neigh, baa, oink, cluck] = animalType
console.log(moo); 

// 2. Bolt the horse wandered off, so just give us four animals, and let's name them bessie, dolly, babe, and little.

const fourAnimals = [...animalType];
...
const animalColors = [...fourAnimals];
animalColors.splice(4,1);
